...
export interface StdioSpawnCommand {
	 ...
	 *
	 * Windows uses this only when the NeoPi host has no console to share. When
	 ...
	 * wrapper chains must stay in the NeoPi console session so nested console
...
export async function resolveStdioSpawnCommand(
	...
	// same console session. Only hide the child when NeoPi itself has no console
