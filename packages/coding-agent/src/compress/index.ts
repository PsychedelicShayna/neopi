/**
 * `npi compress` — rewrite text files into the dense prompt register.
 *
...
/** User-facing options for `npi compress`. */
 ...
 * stdout for a single-file run (`npi compress f.md > out.md`).
 */
