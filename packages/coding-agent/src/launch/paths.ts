...
/** Resolve the private runtime directory shared by NeoPi processes in one project directory. */
 ...
 * Written by the broker at startup so out-of-process inspectors (`npi ps`)
