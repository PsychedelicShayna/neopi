 ...
 * project with NeoPi's own assets and was the source of issue #1423 (the host
 * project's `CHANGELOG.md` rendered as NeoPi's startup changelog).
 */
...
/**
 * Path to NeoPi's own `CHANGELOG.md`, or `undefined` when the package directory
