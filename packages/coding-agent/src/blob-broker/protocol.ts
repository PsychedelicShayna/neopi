 ...
 * broker that owns the shared Chromium and LSP mux), so every npi process in
...
export const BLOB_BROKER_READY_PATTERN = String.raw`${APP_NAME} blob broker serving \S+`;
