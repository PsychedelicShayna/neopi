/**
 * Shared chart primitives for the dashboard timeline charts: the NeoPi color
...
// NeoPi brand palette (packages/collab-web/src/styles/tokens.css): pink/purple/cyan.
