 ...
 * the NeoPi-wide stream watchdog removed in #1392: a WebSocket can stay TCP-open
...
/** Raw provider usage plus the normalized buckets NeoPi displays for the latest Codex turn. */
