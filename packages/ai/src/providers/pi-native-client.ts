 ...
 *
 * Dispatches a {@link streamSimple}-shaped request to a NeoPi auth-gateway
 ...
 * containerized NeoPi deployments (such as robomp slots) that
...
/**
 * Stream a turn through a NeoPi auth-gateway over the pi-native protocol.
 *
