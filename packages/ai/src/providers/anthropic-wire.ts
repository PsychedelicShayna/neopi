...
/** Web-search server-tool call whose matching result is replayable by NeoPi. */
export type WebSearchServerToolUseBlockParam = ServerToolUseBlockParam & { name: "web_search" };

/** Tool-search server-tool call whose matching result is replayable by NeoPi. */
...
/** Anthropic server-tool history variants NeoPi can replay atomically. */
...
/** True when a block is complete Anthropic server-tool history NeoPi can replay. */
