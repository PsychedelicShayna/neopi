 ...
 * (containerized NeoPi, robomp's sidecar auth-gateway).
 ...
 * `SimpleStreamOptions` from older / newer NeoPi builds without per-version
 * conditionals.
 */
 ...
 * targets (containerized NeoPi → host gateway, robomp slot → npi-auth-gateway
