...
export interface AgentLoopConfig extends SimpleStreamOptions {
	 ...
	 * (the queued message's override, otherwise interruptMode) should abort in-flight
	 * and skip not-yet-started *interruptible* waits, and whether to raise the
	 * cooperative soft signal ("wait" withholds only the soft signal);
